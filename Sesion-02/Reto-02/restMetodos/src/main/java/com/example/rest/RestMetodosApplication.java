...
public class RestMetodosApplication {
	...
	public static void main(String[] args) {
		...
		phones.add(new Phone(546465468));
		//post
		  restTemplate = new RestTemplate();
		  HttpEntity<User> request2 = new HttpEntity<>(new User("Test", "test@test.com",phones));
		...
		//get
			...
			//put
			  restTemplate = new RestTemplate();
			  request2 = new HttpEntity<>(new User(1,"Test put", "test@test.com",phones));
