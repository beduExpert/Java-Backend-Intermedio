...
public class PostworkS1Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        mappingService.mappingPatient().subscribe();
        ...
        patient = patientRepository.save(patient).block();
        ...
        disease = diseasesRepository.save(disease).block();
        ...
        medicament = medicamentRepository.save(medicament).block();

        MedicationDetail medicationDetail = new MedicationDetail(null, medicament, 7, 8, "5 drops");
        medicationDetail = medicationDetailRepository.save(medicationDetail).block();
        ...
        prescriptionRepository.save(prescription).block();
